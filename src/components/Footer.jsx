    ...
    <footer className="bg-gray-800 ">
        <div className="max-w-screen-xl  py-6 mx-auto lg:py-16 md:p-8 lg:p-10 ">
                ...
                <div>
                    ...
                    <ul className="text-gray-500 dark:text-gray-400 ">
                        <li className="mb-4 text-center lg:text-left text-2xl lg:text-sm py-1 ">
                            <a href="/" className="hover:underline">sales@talenta-unggul.com</a>
                        </li>
                        <li className="mb-4 text-center lg:text-left text-2xl lg:text-sm py-1 ">
                            <a href="#" className="hover:underline">Twitter name</a>
                        </li>
                        <li className="mb-4 text-center lg:text-left text-2xl lg:text-sm py-1 ">
            ...
            <div className="text-center">
                ...
                <span className="block text-sm text-center text-gray-500 dark:text-gray-400">Copyright © 2024 Talenta Unggul. All rights reserved.</span>
