  ...
  return (
    ...
    <section>
      <div className="w-full overflow-hidden relative">
        <img src={Article} alt="" className="h-40vh object-cover brightness-50 lg:w-full" />
        <p
      ...
      <div className="grid my-32 lg:my-16   grid-cols-1 lg:grid-cols-4">
        <div className="w-45vh overflow-hidden relative mx-auto drop-shadow-2xl hover:drop-shadow-sm rounded-3xl">
            ...
            <p className="text-4xl my-7 hover:text-Orange lg:text-lg lg:my-3 cursor-pointer underline text-blue-700">Pemakaian teknologi iot untuk memonitoring kinerja apa kek </p>
