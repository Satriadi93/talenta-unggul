...
<>
  ...
  <section>
    ...
    <div className="bg-about bg-cover relative lg:pb-20" >
      ...
      <div data-aos="fade-up" data-aos-anchor-placement="center-bottom" className=" grid grid-cols-1 lg:grid-cols-3 relative z-10 lg:mx-20 lg:pt-20 py-20">
        <div className="">
    ...
    <div className="">
      <div className="text-8xl lg:text-6xl font-bold py-20 text-white text-center ">Our <span
          className="text-Orange">Product</span></div>
      <div className="grid grid-cols-2 lg:grid-cols-4 mb-20 mx-20">
        <img src={Img3} alt="" className="w-60 mx-auto my-10" />
        <img src={Img3} alt="" className="w-60 mx-auto my-10" />
        <img src={Img3} alt="" className="w-60 mx-auto my-10" />
        <img src={Img3} alt="" className="w-60 mx-auto my-10" />
        <img src={Img3} alt="" className="w-60 mx-auto my-10" />
